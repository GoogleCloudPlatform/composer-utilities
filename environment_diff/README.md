...
environment_diff is a python command line tool to diff two Cloud Composer environments.
...
navigate to the environment_diff directory

from within the environment_diff directory run the following command
...
named "environment_diff.json". To request a JSON file, an additional flag is required
