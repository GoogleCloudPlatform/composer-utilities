...
from environment_diff.lib.comparator import EnvironmentComparator
from environment_diff.lib.strategies.diff_airflow_config import DiffAirflowConfig
from environment_diff.lib.strategies.diff_env_image import DiffEnvImage
from environment_diff.lib.strategies.diff_env_variables import DiffEnvVariables
from environment_diff.lib.strategies.diff_pypi_packages import DiffPyPiPackages
...
def main(
    ...
    """The environment_diff tool for comparing Cloud Composer environments."""
