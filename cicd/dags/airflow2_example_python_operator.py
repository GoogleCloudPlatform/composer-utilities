...
# 3. schedule argument is used instead of deprecated schedule_interval.
# 4. Context arguments access logical_date instead of removed execution_date.
# 5. default_args configured with retries and retry_delay (Rule 6).
